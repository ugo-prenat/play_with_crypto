...
import hamburger from '../anim/hamburger.json'
...
function Menu(props) {
    ...
    return (
        <div className={isRetract ? "retracted-menu bottom-menu" : "menu-container bottom-menu"}>
          ...
          <div className="bottom-menu-container">
            ...
            <div className="links" style={{ right: showOptions ? '15px' : '-100%' }}>
              <Link to='/settings' style={props.location.pathname === '/settings' ? {opacity: 1} : {}} onClick={() => animate()}>
              ...
              <Link to='/about' style={props.location.pathname === '/about' ? {opacity: 1} : {}} onClick={() => animate()}>
              ...
              <Link to='/login' style={props.location.pathname === '/login' ? {opacity: 1} : {}} onClick={() => {localStorage.clear(); animate()}}>
            ...
            <div className="hamburger" onClick={() => animate()}>
              <Lottie
